...
const CreateTrip = () => {
 ...
 // };
  ...
  return (
    ...
    style={{
      backgroundImage: "url('Wonderland.gif')",
      ...
      <div className="flex flex-col w-full max-w-2xl mb-8">
        <label className="text-white text-2xl font-semibold mb-2">
            ...
            <div
              ...
              className={`rounded-xl border-2 border-transparent hover:border-blue-500 hover:bg-white transition-all duration-300 p-6 cursor-pointer ${
                formData?.budget === item.title
                  ? "shadow-lg bg-purple-900 text-white"
                  : "bg-white"
              }`}
      ...
      <div className="flex justify-center w-full max-w-2xl">
        <Button
          ...
          disabled={loading}
          className="w-full py-3 text-lg bg-lime-300 hover:bg-lime-600 text-black"
        >
