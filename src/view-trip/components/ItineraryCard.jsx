    ...
    >
      <div className="flex flex-col bg-white rounded-lg shadow-md overflow-hidden transition-transform transform hover:scale-105 duration-300 itinerary-card">
        ...
        <div className="p-4 bg-black">
          ...
          <p className="flex items-center text-md mb-2 text-white">
            <CiStar className="text-yellow-500 mr-1" />
            {plan.rating}
          </p>
          <p className="flex items-center text-md mb-1 text-white">
          ...
          <p className="text-md text-white truncate">{plan.placeDetails}</p>
        </div>
      </div>
    </Link>
  );
