      ...
      >
        ...
        <div className="relative z-10 text-center mb-12 text-white">
          <h1 className="text-5xl font-extrabold hero-title mb-4 ">
            Discover Your Perfect Trip with VoyageVerse
          </h1>
          <p className="text-xl hero-description mb-3 font-semibold">
          VoyageVerse is your ultimate AI-powered travel companion. Tell us
        ...
        <div className="cta-section relative z-10 text-center mb-12">
          ...
          <Link to="/create-trip">
            <Button className="py-3 px-6 text-lg font-bold bg-black text-white hover:bg-gray-500">
             Start Planning Now
           </Button>
